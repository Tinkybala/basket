...
class NotificationPreferenceForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['is_enabled']  # Only the toggle for notification preference

    def __init__(self, *args, **kwargs):
        participant = kwargs.pop('participant')
        notification_type = kwargs.pop('notification_type')
        super().__init__(*args, **kwargs)
        self.instance.notification_type = notification_type
        self.fields['is_enabled'].label = f"{participant.username} - {notification_type.capitalize()}"